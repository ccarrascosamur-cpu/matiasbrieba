...
const DEFAULT_DATA = {
  projects: [
    { id: 1, order: 1, name: 'Barra Central', client: 'Barra Central', cat: 'film', year: 2024, img: '', url: '', videoUrl: '', videos: [], images: [], desc: 'Producción audiovisual para Barra Central.', featured: true },
    { id: 2, order: 2, name: 'Monster Energy Chile', client: 'Monster Energy', cat: 'foto', year: 2024, img: '', url: 'https://matiasbriebaf.myportfolio.com/monster-energy-chile', videoUrl: '', videos: [], images: [], desc: 'Fotografía deportiva y lifestyle para Monster Energy.', featured: true },
    { id: 3, order: 3, name: 'Juan Valdez Café', client: 'Juan Valdez', cat: 'corp', year: 2024, img: '', url: 'https://matiasbriebaf.myportfolio.com/juan-valdez-cafe', videoUrl: '', videos: [], images: [], desc: 'Fotografía de producto y corporativa para Juan Valdez.', featured: true },
    { id: 4, order: 4, name: 'Xclusive Chile', client: 'Xclusive', cat: 'foto', year: 2024, img: '', url: 'https://matiasbriebaf.myportfolio.com/xclusive-chile', videoUrl: '', videos: [], images: [], desc: 'Contenido visual para Xclusive Chile.', featured: true },
    { id: 5, order: 5, name: 'Nevados de Chillán', client: 'Nevados de Chillán', cat: 'deporte', year: 2024, img: '', url: 'https://matiasbriebaf.myportfolio.com/nevados-de-chillan', videoUrl: '', videos: [], images: [], desc: 'Fotografía deportiva en nieve y montaña.', featured: true },
    { id: 6, order: 6, name: 'Chile Suplementos', client: 'Chile Suplementos', cat: 'corp', year: 2024, img: '', url: 'https://matiasbriebaf.myportfolio.com/chile-suplementos', videoUrl: '', videos: [], images: [], desc: 'Fotografía de producto y corporativa.', featured: true },
