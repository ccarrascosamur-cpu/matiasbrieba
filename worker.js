...
const DEFAULT_DATA = {
  projects: [
    { id: 1, order: 1, name: 'Barra Central', client: 'Barra Central', cat: 'film', year: 2024, img: '', logo: '', url: '', videoUrl: '', videos: [], images: [], desc: 'Producción audiovisual para Barra Central.', featured: true },
    { id: 2, order: 2, name: 'Monster Energy Chile', client: 'Monster Energy', cat: 'foto', year: 2024, img: '', logo: '', url: 'https://matiasbriebaf.myportfolio.com/monster-energy-chile', videoUrl: '', videos: [], images: [], desc: 'Fotografía deportiva y lifestyle para Monster Energy.', featured: true },
    { id: 3, order: 3, name: 'Juan Valdez Café', client: 'Juan Valdez', cat: 'corp', year: 2024, img: '', logo: '', url: 'https://matiasbriebaf.myportfolio.com/juan-valdez-cafe', videoUrl: '', videos: [], images: [], desc: 'Fotografía de producto y corporativa para Juan Valdez.', featured: true },
    { id: 4, order: 4, name: 'Xclusive Chile', client: 'Xclusive', cat: 'foto', year: 2024, img: '', logo: '', url: 'https://matiasbriebaf.myportfolio.com/xclusive-chile', videoUrl: '', videos: [], images: [], desc: 'Contenido visual para Xclusive Chile.', featured: true },
    { id: 5, order: 5, name: 'Nevados de Chillán', client: 'Nevados de Chillán', cat: 'deporte', year: 2024, img: '', logo: '', url: 'https://matiasbriebaf.myportfolio.com/nevados-de-chillan', videoUrl: '', videos: [], images: [], desc: 'Fotografía deportiva en nieve y montaña.', featured: true },
    { id: 6, order: 6, name: 'Chile Suplementos', client: 'Chile Suplementos', cat: 'corp', year: 2024, img: '', logo: '', url: 'https://matiasbriebaf.myportfolio.com/chile-suplementos', videoUrl: '', videos: [], images: [], desc: 'Fotografía de producto y corporativa.', featured: true },
    { id: 7, order: 7, name: 'Cruzados', client: 'Cruzados', cat: 'deporte', year: 2024, img: '', logo: '', url: 'https://matiasbriebaf.myportfolio.com/cruzados', videoUrl: '', videos: [], images: [], desc: 'Fútbol y deporte de alta emoción.', featured: true },
    { id: 8, order: 8, name: 'Tamango Brebajes', client: 'Tamango', cat: 'film', year: 2024, img: '', logo: '', url: 'https://matiasbriebaf.myportfolio.com/tamango-brebajes', videoUrl: '', videos: [], images: [], desc: 'Producción audiovisual y branding visual.', featured: false },
    { id: 9, order: 9, name: 'Santiago 2023', client: 'Personal', cat: 'foto', year: 2024, img: '', logo: '', url: 'https://matiasbriebaf.myportfolio.com/santiago-2023', videoUrl: '', videos: [], images: [], desc: 'Reportaje fotográfico de Santiago.', featured: false },
    { id: 10, order: 10, name: 'Bruno Fritsch', client: 'Bruno Fritsch', cat: 'foto', year: 2024, img: '', logo: '', url: 'https://matiasbriebaf.myportfolio.com/bruno-fristch', videoUrl: 'https://drive.google.com/file/d/1APph2KaLNXxoYQbsQaKQVuUJjfGKWoeq/view?usp=drive_link', videos: ['https://drive.google.com/file/d/1APph2KaLNXxoYQbsQaKQVuUJjfGKWoeq/view?usp=drive_link','https://drive.google.com/file/d/1lQbZVQCDNoR-mdRZc5XjcfMn3xIBZUMt/view?usp=drive_link','https://drive.google.com/file/d/1hbiR2Iam8jmVvj443iAMMewieEj658Wv/view?usp=drive_link'], images: [], desc: 'Retrato y fotografía artística.', featured: false },
  ],
  clients: [
